...
public class Config {
    ...
    public Config() {
        this.listenAddr = DEFAULT_LISTEN;
        this.rProxy = DEFAULT_RPROXY;
        this.payload = DEFAULT_PAYLOAD;
        this.sshHost = DEFAULT_SSH_HOST;
        this.sshPort = DEFAULT_SSH_PORT;
        this.sshUser = DEFAULT_SSH_USER;
        this.sshPass = DEFAULT_SSH_PASS;
        this.socksPort = DEFAULT_SOCKS_PORT;
        this.useSSH = DEFAULT_USAR_SSH;
        this.sshLocked = DEFAULT_LOCK_SSH;
        this.rproxyLocked = DEFAULT_LOCK_RPROXY;
        this.payloadLocked= DEFAULT_LOCK_PAYLOAD;
    }
